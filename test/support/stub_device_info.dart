...
class StubDeviceInfoPlugin implements DeviceInfoPlugin {
  StubDeviceInfoPlugin({this.androidId = 'stub-android-id', this.iosId = 'stub-ios-id'});
  ...
  Future<LinuxDeviceInfo> get linuxInfo =>
      Future<LinuxDeviceInfo>.error(UnsupportedError('linuxInfo is not supported in StubDeviceInfoPlugin.'));

  @override
  Future<MacOsDeviceInfo> get macOsInfo =>
      Future<MacOsDeviceInfo>.error(UnsupportedError('macOsInfo is not supported in StubDeviceInfoPlugin.'));

  @override
  Future<WebBrowserInfo> get webBrowserInfo =>
      Future<WebBrowserInfo>.error(UnsupportedError('webBrowserInfo is not supported in StubDeviceInfoPlugin.'));

  @override
  Future<WindowsDeviceInfo> get windowsInfo =>
      Future<WindowsDeviceInfo>.error(UnsupportedError('windowsInfo is not supported in StubDeviceInfoPlugin.'));
}
